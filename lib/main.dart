...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(  // Wrap the body in a scroll view to ensure content isn't cut off
        child: Padding(
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: [
                  ...
                  _buildCategoryImage('images/pork.jpg', 'Pork'),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  _buildCategoryImage('images/brownies.jpg', 'Brownies'),
                  _buildCategoryImage('images/pies.jpg', 'Pies'),
